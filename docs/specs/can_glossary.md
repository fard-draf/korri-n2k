...
- **Technical Role:** Under NMEA 2000, this bit MUST be **0**. Other J1939-based protocols (e.g., truck FMS) can reuse it as the Extended Data Page (EDP).
- **Architectural Impact:** Parsing code should enforce this bit to 0 to remain strictly compliant with the NMEA 2000 specification.
